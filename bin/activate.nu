...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/hagayhadad/PycharmProjects/world of game‏‏‏‏/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/hagayhadad/PycharmProjects/world of game‏‏‏‏/venv/bin/deactivate.nu'
